...
/// @title Poly token contract.
contract PolyToken is Ownable, ERC20, TokenHolder {
    using SafeMath for uint256;

    string public constant name = "Polymath";
    string public constant symbol = "POLY";

    // Using same decimal value as ETH (makes ETH-POLY conversion much easier).
    ...
    /// @dev Mint Poly tokens.
    /// @param _to address Address to send minted Poly to.
    /// @param _amount uint256 Amount of Poly tokens to mint.
